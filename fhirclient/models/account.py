...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/Account) on 2022-10-13.
...
class Account(domainresource.DomainResource):
    ...
    _attribute_types['servicePeriod'] = 'Period'
    _attribute_types['coverage'] = 'List[AccountCoverage]'
    _attribute_types['owner'] = 'FHIRReference'
    _attribute_types['description'] = 'str'
    _attribute_types['guarantor'] = 'List[AccountGuarantor]'
