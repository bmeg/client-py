...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/List) on 2022-10-13.
...
class List(domainresource.DomainResource):
    ...
    _attribute_types['entry'] = 'List[ListEntry]'
...
class ListEntry(backboneelement.BackboneElement):
    ...
    _attribute_types = {}
    """ Dictionary of attribute types."""
    _attribute_types['flag'] = 'CodeableConcept'
    _attribute_types['deleted'] = 'bool'
    _attribute_types['date'] = 'FHIRDate'
