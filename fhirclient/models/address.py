...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/Address) on 2022-10-13.
...
class Address(element.Element):
    ...
    _attribute_types['line'] = 'List[str]'
    _attribute_types['city'] = 'str'
    _attribute_types['district'] = 'str'
    _attribute_types['state'] = 'str'
    _attribute_types['postalCode'] = 'str'
    _attribute_types['country'] = 'str'
