...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/EffectEvidenceSynthesis) on 2022-10-13.
...
class EffectEvidenceSynthesis(domainresource.DomainResource):
    ...
    _attribute_types['exposureAlternative'] = 'FHIRReference'
    _attribute_types['outcome'] = 'FHIRReference'
    _attribute_types['sampleSize'] = 'EffectEvidenceSynthesisSampleSize'
    _attribute_types['resultsByExposure'] = 'List[EffectEvidenceSynthesisResultsByExposure]'
    _attribute_types['effectEstimate'] = 'List[EffectEvidenceSynthesisEffectEstimate]'
    _attribute_types['certainty'] = 'List[EffectEvidenceSynthesisCertainty]'
...
class EffectEvidenceSynthesisCertainty(backboneelement.BackboneElement):
    ...
    _attribute_types['note'] = 'List[Annotation]'
    _attribute_types['certaintySubcomponent'] = 'List[EffectEvidenceSynthesisCertaintyCertaintySubcomponent]'
...
class EffectEvidenceSynthesisEffectEstimate(backboneelement.BackboneElement):
    ...
    _attribute_types['description'] = 'str'
    _attribute_types['type'] = 'CodeableConcept'
    _attribute_types['variantState'] = 'CodeableConcept'
    _attribute_types['value'] = 'float'
    _attribute_types['unitOfMeasure'] = 'CodeableConcept'
    _attribute_types['precisionEstimate'] = 'List[EffectEvidenceSynthesisEffectEstimatePrecisionEstimate]'
...
class EffectEvidenceSynthesisResultsByExposure(backboneelement.BackboneElement):
    ...
    """ Dictionary of attribute types."""
    _attribute_types['description'] = 'str'
    _attribute_types['exposureState'] = 'str'
    _attribute_types['variantState'] = 'CodeableConcept'
    _attribute_types['riskEvidenceSynthesis'] = 'FHIRReference'
