...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/HumanName) on 2022-10-13.
...
class HumanName(element.Element):
    ...
    _attribute_types['family'] = 'str'
    _attribute_types['given'] = 'List[str]'
    _attribute_types['prefix'] = 'List[str]'
    _attribute_types['suffix'] = 'List[str]'
