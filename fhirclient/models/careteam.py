...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/CareTeam) on 2022-10-13.
...
class CareTeam(domainresource.DomainResource):
    ...
    _attribute_types['participant'] = 'List[CareTeamParticipant]'
    _attribute_types['reasonCode'] = 'List[CodeableConcept]'
    _attribute_types['reasonReference'] = 'List[FHIRReference]'
    _attribute_types['managingOrganization'] = 'List[FHIRReference]'
...
class CareTeamParticipant(backboneelement.BackboneElement):
    ...
    _attribute_types['member'] = 'FHIRReference'
