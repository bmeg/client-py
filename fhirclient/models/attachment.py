...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/Attachment) on 2022-10-13.
...
class Attachment(element.Element):
    ...
    _attribute_types['size'] = 'int'
    _attribute_types['hash'] = 'str'
    _attribute_types['title'] = 'str'
    _attribute_types['creation'] = 'FHIRDate'
