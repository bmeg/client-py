...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/Resource) on 2022-10-13.
...
class Resource(fhirabstractresource.FHIRAbstractResource):
    ...
    def attribute_docstrings(cls):
        ...
        return cls._attribute_docstrings | fhirabstractresource.FHIRAbstractResource.attribute_docstrings()

    _attribute_types = {}
    """ Dictionary of attribute types."""
    _attribute_types['id'] = 'str'
    _attribute_types['meta'] = 'Meta'
    _attribute_types['implicitRules'] = 'str'
