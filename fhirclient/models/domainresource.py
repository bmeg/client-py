...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/DomainResource) on 2022-10-13.
...
class DomainResource(resource.Resource):
    ...
    _attribute_types['contained'] = 'List[Resource]'
    _attribute_types['extension'] = 'List[Extension]'
    _attribute_types['modifierExtension'] = 'List[Extension]'
