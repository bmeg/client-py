...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/ConceptMap) on 2022-10-13.
...
class ConceptMap(domainresource.DomainResource):
    ...
    _attribute_types['sourceUri'] = 'str'
    _attribute_types['sourceCanonical'] = 'str'
    _attribute_types['targetUri'] = 'str'
    _attribute_types['targetCanonical'] = 'str'
    _attribute_types['group'] = 'List[ConceptMapGroup]'
...
class ConceptMapGroup(backboneelement.BackboneElement):
    ...
    _attribute_types['sourceVersion'] = 'str'
    _attribute_types['target'] = 'str'
    _attribute_types['targetVersion'] = 'str'
    _attribute_types['element'] = 'List[ConceptMapGroupElement]'
    _attribute_types['unmapped'] = 'ConceptMapGroupUnmapped'
...
class ConceptMapGroupElement(backboneelement.BackboneElement):
    ...
    _attribute_types['target'] = 'List[ConceptMapGroupElementTarget]'
...
class ConceptMapGroupElementTarget(backboneelement.BackboneElement):
    ...
    _attribute_types['code'] = 'str'
    _attribute_types['display'] = 'str'
    _attribute_types['equivalence'] = 'str'
    _attribute_types['comment'] = 'str'
    _attribute_types['dependsOn'] = 'List[ConceptMapGroupElementTargetDependsOn]'
    _attribute_types['product'] = 'List[ConceptMapGroupElementTargetDependsOn]'
