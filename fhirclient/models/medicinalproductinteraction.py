...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/MedicinalProductInteraction) on 2022-10-13.
...
class MedicinalProductInteraction(domainresource.DomainResource):
    ...
    _attribute_types['interactant'] = 'List[MedicinalProductInteractionInteractant]'
    _attribute_types['type'] = 'CodeableConcept'
    _attribute_types['effect'] = 'CodeableConcept'
    _attribute_types['incidence'] = 'CodeableConcept'
    _attribute_types['management'] = 'CodeableConcept'
