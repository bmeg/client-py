...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/OperationOutcome) on 2022-10-13.
...
class OperationOutcome(domainresource.DomainResource):
    ...
    _attribute_types['issue'] = 'List[OperationOutcomeIssue]'
...
class OperationOutcomeIssue(backboneelement.BackboneElement):
    ...
    _attribute_types['details'] = 'CodeableConcept'
    _attribute_types['diagnostics'] = 'str'
    _attribute_types['location'] = 'List[str]'
    _attribute_types['expression'] = 'List[str]'
