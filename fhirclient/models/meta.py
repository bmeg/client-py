...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/Meta) on 2022-10-13.
...
class Meta(element.Element):
    ...
    _attribute_types['security'] = 'List[Coding]'
    _attribute_types['tag'] = 'List[Coding]'
