...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/Subscription) on 2022-10-13.
...
class Subscription(domainresource.DomainResource):
    ...
    _attribute_types['reason'] = 'str'
    _attribute_types['criteria'] = 'str'
    _attribute_types['error'] = 'str'
    _attribute_types['channel'] = 'SubscriptionChannel'
...
class SubscriptionChannel(backboneelement.BackboneElement):
    ...
    _attribute_types['payload'] = 'str'
    _attribute_types['header'] = 'List[str]'
