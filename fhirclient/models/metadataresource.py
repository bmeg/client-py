...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/MetadataResource) on 2022-10-13.
...
class MetadataResource(object):
    ...
    def attribute_docstrings(cls):
        ...
        return cls._attribute_docstrings | ..attribute_docstrings()
