...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/CoverageEligibilityResponse) on 2022-10-13.
...
class CoverageEligibilityResponse(domainresource.DomainResource):
    ...
    _attribute_types['insurance'] = 'List[CoverageEligibilityResponseInsurance]'
    _attribute_types['preAuthRef'] = 'str'
    _attribute_types['form'] = 'CodeableConcept'
    _attribute_types['error'] = 'List[CoverageEligibilityResponseError]'
...
class CoverageEligibilityResponseInsurance(backboneelement.BackboneElement):
    ...
    _attribute_types['inforce'] = 'bool'
    _attribute_types['benefitPeriod'] = 'Period'
    _attribute_types['item'] = 'List[CoverageEligibilityResponseInsuranceItem]'
...
class CoverageEligibilityResponseInsuranceItem(backboneelement.BackboneElement):
    ...
    _attribute_types['benefit'] = 'List[CoverageEligibilityResponseInsuranceItemBenefit]'
    _attribute_types['authorizationRequired'] = 'bool'
    _attribute_types['authorizationSupporting'] = 'List[CodeableConcept]'
    _attribute_types['authorizationUrl'] = 'str'
...
class CoverageEligibilityResponseInsuranceItemBenefit(backboneelement.BackboneElement):
    ...
    _attribute_types['usedString'] = 'str'
