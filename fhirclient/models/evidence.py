...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/Evidence) on 2022-10-13.
...
class Evidence(domainresource.DomainResource):
    ...
    _attribute_types['exposureBackground'] = 'FHIRReference'
    _attribute_types['exposureVariant'] = 'List[FHIRReference]'
    _attribute_types['outcome'] = 'List[FHIRReference]'
