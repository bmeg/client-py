...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/SampledData) on 2022-10-13.
...
class SampledData(element.Element):
    ...
    _attribute_types['origin'] = 'Quantity'
    _attribute_types['period'] = 'float'
    _attribute_types['factor'] = 'float'
    _attribute_types['lowerLimit'] = 'float'
    _attribute_types['upperLimit'] = 'float'
    _attribute_types['dimensions'] = 'int'
    _attribute_types['data'] = 'str'
