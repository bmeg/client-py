...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 4.0.1-9346c8cc45 (http://hl7.org/fhir/StructureDefinition/BodyStructure) on 2022-10-13.
...
class BodyStructure(domainresource.DomainResource):
    ...
    _attribute_types['morphology'] = 'CodeableConcept'
    _attribute_types['location'] = 'CodeableConcept'
    _attribute_types['locationQualifier'] = 'List[CodeableConcept]'
